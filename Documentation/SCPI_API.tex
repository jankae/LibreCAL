...
\item \textbf{Coefficient:} A list of coefficient data, containing multiplt points over a frequency range. Each coefficient within a coefficient set is identified by its coefficient name. This name can be any of the following:
\begin{itemize}
\item P1\_OPEN
\item P1\_SHORT
\item P1\_LOAD
